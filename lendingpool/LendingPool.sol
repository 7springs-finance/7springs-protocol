...
contract LendingPool is ReentrancyGuard, VersionedInitializable {
    ...
    * this is regulated by 7springs to ensure that the protocol is not abused, and the user is paying a fair
    ...
    * that must be kept into consideration. For further details please visit https://developers.7springs.com
